...
ZIP=/tmp/pango-1.29.3.zip
DEVZIP=/tmp/pango-dev-1.29.3.zip
cd /usr/local

mkdir -p share/doc/pango-1.29.3
cp -p /home/tjw/tjKindle/GTK0/pango-1.29.3/COPYING share/doc/pango-1.29.3

mkdir -p share/doc/pango-dev-1.29.3
cp -p /home/tjw/tjKindle/GTK0/pango-1.29.3/COPYING share/doc/pango-dev-1.29.3
...
zip -r $ZIP share/doc/pango-1.29.3
...
zip -r $DEVZIP share/doc/pango-dev-1.29.3
