...
int basic_keycodes [] = {
     ...
     DIKI_N, DIKI_M, DIKI_COMMA, DIKI_PERIOD, DIKI_SLASH, DIKI_SHIFT_R,    //49-54
     DIKI_KP_MULT, DIKI_ALT_L, DIKI_SPACE, DIKI_CAPS_LOCK,                 //55-58

     DIKI_F1, DIKI_F2, DIKI_F3, DIKI_F4, DIKI_F5, DIKI_F6, DIKI_F7, DIKI_F8, //59-66
     DIKI_F9, DIKI_F10, DIKI_NUM_LOCK, DIKI_SCROLL_LOCK,                     //67-70

     DIKI_KP_7, DIKI_KP_8, DIKI_KP_9, DIKI_KP_MINUS,                        //71-74
     DIKI_KP_4, DIKI_KP_5, DIKI_KP_6, DIKI_KP_PLUS,                         //75-78
     DIKI_KP_1, DIKI_KP_2, DIKI_KP_3, DIKI_KP_0, DIKI_KP_DECIMAL,           //79-83

     /*KEY_103RD,*/ DIKI_BACKSLASH,                                      //84
     /*KEY_F13,*/ DFB_FUNCTION_KEY(13),                                  //85
     /*KEY_102ND*/ DIKI_LESS_SIGN,                                      //86

     DIKI_F11, DIKI_F12, DFB_FUNCTION_KEY(14), DIKI_ALT_R,   //87-90
     DIKS_BACK, DFB_FUNCTION_KEY(17), DFB_FUNCTION_KEY(18),  //91-93
     DIKI_TAB, DFB_FUNCTION_KEY(20),                       //94-95

     DIKI_KP_ENTER, DIKI_CONTROL_R, DIKI_KP_DIV, DIKI_PRINT, DIKS_ALTGR,  //96-100

     /*KEY_LINEFEED*/ DIKI_UNKNOWN,  //101
     DIKI_HOME, DIKI_UP, DIKI_PAGE_UP, DIKI_LEFT, DIKI_RIGHT,         //102-106
     DIKI_END, DIKI_DOWN, DIKI_PAGE_DOWN, DIKI_INSERT, DIKI_DELETE,   //107-111

     /*KEY_MACRO,*/ DIKI_UNKNOWN, //112

     DIKS_MUTE, DIKS_VOLUME_DOWN, DIKS_VOLUME_UP, DIKS_POWER, DIKI_KP_EQUAL,  /*113-117*/

     /*KEY_KPPLUSMINUS,*/ DIKI_UNKNOWN,  //118

     DIKS_PAUSE, DFB_FUNCTION_KEY(21), DFB_FUNCTION_KEY(22),   //119-121
     DIKI_UP, DIKI_DOWN,                       //122-123  tjw

     DIKI_KP_SEPARATOR, DIKI_META_L, DIKI_META_R, DIKI_SUPER_L, //124-127

     DIKS_STOP, //128

     /*DIKS_AGAIN, DIKS_PROPS, DIKS_UNDO, DIKS_FRONT, DIKS_COPY,
     DIKS_OPEN, DIKS_PASTE, DIKS_FIND, DIKS_CUT,*/
     DIKI_UNKNOWN, DIKI_UNKNOWN, DIKI_UNKNOWN, DIKI_UNKNOWN, DIKI_UNKNOWN, //129-133
     DIKI_UNKNOWN, DIKI_UNKNOWN, DIKI_UNKNOWN, DIKI_UNKNOWN,  //134-137

     DIKS_HELP, DIKS_MENU, DIKS_CALCULATOR, DIKS_SETUP,  //138-141
     ...
     /*KEY_PROG1, KEY_PROG2,*/
     DIKS_CUSTOM1, DIKS_CUSTOM2,  //148-149

     DIKS_INTERNET, //150

     /*KEY_MSDOS, KEY_COFFEE, KEY_DIRECTION, KEY_CYCLEWINDOWS,*/
     DIKI_UNKNOWN, DIKI_UNKNOWN, DIKI_UNKNOWN, DIKI_UNKNOWN,  //154

     DIKS_MAIL,

     /*KEY_BOOKMARKS, KEY_COMPUTER, */
     DIKI_UNKNOWN, DIKI_UNKNOWN,  //157

     DIKS_BACK, DIKS_FORWARD,  //158 159

     /*KEY_CLOSECD, KEY_EJECTCD, KEY_EJECTCLOSECD,*/
     DIKS_EJECT, DIKS_EJECT, DIKS_EJECT,  //162

     DIKS_NEXT, DIKS_PLAYPAUSE, DIKS_PREVIOUS, DIKS_STOP, DIKS_RECORD,
     DIKS_REWIND, DIKS_PHONE,

     /*KEY_ISO,*/ DIKI_UNKNOWN,  //170
     /*KEY_CONFIG,*/ DIKS_SETUP, //171
     /*KEY_HOMEPAGE, KEY_REFRESH,*/ DIKI_UNKNOWN, DIKS_SHUFFLE,

     DIKS_EXIT, /*KEY_MOVE,*/ DIKI_UNKNOWN, DIKS_EDITOR,  //176

     /*KEY_SCROLLUP,*/ DIKS_PAGE_UP,                //177
     /*KEY_SCROLLDOWN,*/ DIKS_PAGE_DOWN,            //178
     ...
     DFB_FUNCTION_KEY(13), DFB_FUNCTION_KEY(14), DFB_FUNCTION_KEY(15),  //183-185
     DFB_FUNCTION_KEY(16), DFB_FUNCTION_KEY(17), DFB_FUNCTION_KEY(18),  //186-188
     DFB_FUNCTION_KEY(19), DFB_FUNCTION_KEY(20), DFB_FUNCTION_KEY(21),  //189-191
     DFB_FUNCTION_KEY(22), DFB_FUNCTION_KEY(23), DFB_FUNCTION_KEY(24),  //192-194
...
translate_key( unsigned short code )
{
     if (code < D_ARRAY_SIZE( basic_keycodes )){
          //printf("in translate_key: using basic_keycodes code = %d\n", code);
          return basic_keycodes[code];
     }

     if (code >= KEY_OK)
          if (code - KEY_OK < D_ARRAY_SIZE( ext_keycodes )){
               //printf("in translate_key: using ext_keycodes code=%d\n", code);
               return ext_keycodes[code-KEY_OK];
          }
     //printf("in translate_key returning DIKI_UNKNOWN code=%d\n", code);
     return DIKI_UNKNOWN;
}
                     ...
                     DFBInputDeviceKeymapSymbolIndex level )
{
     ...
     switch (value) {
          ...
          case 90:     return DIKS_ALT;          //tjw Aa as alt
...
keyboard_get_identifier( int code, unsigned short value )
{
     ...
     switch (code) {
          ...
          case 90: return DIKI_ALT_R;  //tjw Aa as ALT_R
          default:
               ;
     }
                    ...
                    void            **driver_data )
{
     ...
     //printf("created input thread tid=%d\n",data->thread);
                         ...
                         DFBInputDeviceKeymapEntry *entry )
{
      ...
      */
     if (!data->vt) {
         /* simply get the identifier and return OK */
         identifier = translate_key( code );
         if (identifier != DIKI_UNKNOWN) {
