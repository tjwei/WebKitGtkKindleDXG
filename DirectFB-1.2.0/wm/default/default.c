                  ...
                  CoreCursorUpdateFlags  flags )
{
     ...
     if (flags & CCUF_DISABLE) {
        ...
        /* <lab126> */
        /* Ensure that the iocl happens when the cursor disappears */
        ...
        DirectFB_AddDirtyRectangle_Fct dirty_rect_fct = kindle_get_dirty_rectangle_cb();
        if (dirty_rect_fct) {
            DFBRectangle rect;
            rect.x = data->cursor_region.x1;
            rect.y = data->cursor_region.y1;
            rect.w = data->cursor_region.x2-data->cursor_region.x1+1;
            rect.h = data->cursor_region.y2-data->cursor_region.y1+1;
            dirty_rect_fct(&rect);
        }
        /* <lab126> */
     }
