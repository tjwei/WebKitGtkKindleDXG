...
soup_message_init (SoupMessage *msg)
{
    ...
    /* <lab126> */
    priv->force_new_connection = FALSE;
    /* </lab126> */
...
/* <lab126> */
/**
 * soup_message_set_force_new_connection:
 * @msg: a #SoupMessage
 * @force_new_connection: if true, the message should not reuse an existing idle connection but create a new one
 **/
void
soup_message_set_force_new_connection (SoupMessage *msg, gboolean force_new_connection)
{
	g_return_if_fail (SOUP_IS_MESSAGE (msg));
    SoupMessagePrivate *priv = SOUP_MESSAGE_GET_PRIVATE (msg);
	priv->force_new_connection = force_new_connection;
}

/**
 * soup_message_get_force_new_connection:
 * @msg: a #SoupMessage
 * @return true if the message should not reuse an existing idle connection but create a new one
 **/
gboolean
soup_message_get_force_new_connection (SoupMessage *msg)
{
	g_return_if_fail (SOUP_IS_MESSAGE (msg));
    SoupMessagePrivate *priv = SOUP_MESSAGE_GET_PRIVATE (msg);
	return priv->force_new_connection;
}
/* </lab126> */
