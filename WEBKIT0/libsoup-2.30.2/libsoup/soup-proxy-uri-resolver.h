...
/* <lab126>: changed because in session-async, the original version caused 2 soup_address_resolve_async calls */ 
typedef void (*SoupProxyURIResolverCallback) (SoupProxyURIResolver *resolver,
					      guint status, SoupURI *proxy_uri, SoupAddress *proxy_addr,
					      gpointer user_data);
/* </lab126> */
