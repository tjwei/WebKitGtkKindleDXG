...
/* <lab216> */
/**
 * soup_connection_clear_unused_timeout:
 * @conn: a #SoupConnection
 *
 * Clears the timeout that automatically closes a connection
 * when not used for a certain time after it got created.
 **/
void
soup_connection_clear_unused_timeout(SoupConnection *conn)
{
    SoupConnectionPrivate *priv;
