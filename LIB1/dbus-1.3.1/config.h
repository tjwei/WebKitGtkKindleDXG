...
#define DBUS_TEST_LAUNCH_HELPER_BINARY "/home/tjw/tjKindle/LIB1/dbus-1.3.1/bus/dbus-daemon-launch-helper-test"
...
#define PACKAGE_STRING "dbus 1.3.1"
...
#define TEST_BUS_BINARY "/home/tjw/tjKindle/LIB1/dbus-1.3.1/bus/dbus-daemon"

/* Full path to test file test/test-exit in builddir */
#define TEST_EXIT_BINARY "/home/tjw/tjKindle/LIB1/dbus-1.3.1/test/test-exit"

/* Full path to test file test/data/invalid-service-files in builddir */
#define TEST_INVALID_SERVICE_DIR "/home/tjw/tjKindle/LIB1/dbus-1.3.1/test/data/invalid-service-files"

/* Full path to test file test/data/invalid-service-files-system in builddir
   */
#define TEST_INVALID_SERVICE_SYSTEM_DIR "/home/tjw/tjKindle/LIB1/dbus-1.3.1/test/data/invalid-service-files-system"

/* Full path to test file test/name-test/test-privserver in builddir */
#define TEST_PRIVSERVER_BINARY "/home/tjw/tjKindle/LIB1/dbus-1.3.1/test/name-test/test-privserver"

/* Full path to test file test/test-segfault in builddir */
#define TEST_SEGFAULT_BINARY "/home/tjw/tjKindle/LIB1/dbus-1.3.1/test/test-segfault"

/* Full path to test file test/test-service in builddir */
#define TEST_SERVICE_BINARY "/home/tjw/tjKindle/LIB1/dbus-1.3.1/test/test-service"

/* Full path to test file test/test-shell-service in builddir */
#define TEST_SHELL_SERVICE_BINARY "/home/tjw/tjKindle/LIB1/dbus-1.3.1/test/test-shell-service"

/* Full path to test file test/test-sleep-forever in builddir */
#define TEST_SLEEP_FOREVER_BINARY "/home/tjw/tjKindle/LIB1/dbus-1.3.1/test/test-sleep-forever"

/* Full path to test file test/data/valid-service-files in builddir */
#define TEST_VALID_SERVICE_DIR "/home/tjw/tjKindle/LIB1/dbus-1.3.1/test/data/valid-service-files"

/* Full path to test file test/data/valid-service-files-system in builddir */
#define TEST_VALID_SERVICE_SYSTEM_DIR "/home/tjw/tjKindle/LIB1/dbus-1.3.1/test/data/valid-service-files-system"
