...
public:
    ...
    WEBCORE_EXPORT Editor* editor() const;
    WEBCORE_EXPORT EventHandler* eventHandler() const;
    WEBCORE_EXPORT FrameLoader* loader() const;
    WEBCORE_EXPORT SelectionController* selection() const;
    WEBCORE_EXPORT FrameTree* tree() const;
    AnimationController* animation() const;
    ScriptController* script();

    WEBCORE_EXPORT RenderView* contentRenderer() const; // root renderer for the document contained in this frame
...
public: 
    WEBCORE_EXPORT void setZoomFactor(float scale, bool isTextOnly);
    WEBCORE_EXPORT float zoomFactor() const;
