...
public:
...
#endif
    WEBCORE_EXPORT String(const char*);
    ...
    WEBCORE_EXPORT const UChar* characters() const;
    ...
    WEBCORE_EXPORT String lower() const;
    String upper() const;

    WEBCORE_EXPORT String stripWhiteSpace() const;
    ...
    WEBCORE_EXPORT static String createUninitialized(unsigned length, UChar*& data) { return StringImpl::createUninitialized(length, data); }
    ...
    WEBCORE_EXPORT CString utf8() const;

    WEBCORE_EXPORT static String fromUTF8(const char*, size_t);
