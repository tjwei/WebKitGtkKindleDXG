...
private:
    ...
    WEBCORE_EXPORT static PassRefPtr<StringImpl> add(const char*);
    WEBCORE_EXPORT static PassRefPtr<StringImpl> add(const UChar*, int length);
    WEBCORE_EXPORT static PassRefPtr<StringImpl> add(const UChar*);
