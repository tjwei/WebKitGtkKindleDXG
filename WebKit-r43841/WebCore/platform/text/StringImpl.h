...
public:
    WEBCORE_EXPORT ~StringImpl();

    static PassRefPtr<StringImpl> create(const UChar*, unsigned length);
    static PassRefPtr<StringImpl> create(const char*, unsigned length);
    static PassRefPtr<StringImpl> create(const char*);
    WEBCORE_EXPORT static PassRefPtr<StringImpl> createUninitialized(unsigned length, UChar*& data);
    ...
    WEBCORE_EXPORT bool endsWith(StringImpl*, bool caseSensitive = true);
    ...
    WEBCORE_EXPORT void operator delete(void*);
...
WEBCORE_EXPORT bool equal(StringImpl*, StringImpl*);
WEBCORE_EXPORT bool equal(StringImpl*, const char*);
