...
public:
    Font();
    WEBCORE_EXPORT Font(const FontDescription&, short letterSpacing, short wordSpacing);
    ...
    WEBCORE_EXPORT void update(PassRefPtr<FontSelector>) const;

    WEBCORE_EXPORT void drawText(GraphicsContext*, const TextRun&, const FloatPoint&, int from = 0, int to = -1) const;
