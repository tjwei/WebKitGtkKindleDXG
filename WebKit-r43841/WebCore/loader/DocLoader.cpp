...
{
	// <lab126>
	KINDLE_PRINT_MODULE(Kindle_Debug_Resources, "Image Request: %s\n", url.latin1().data());
	// </lab126>
...
{
	// <lab126>
	KINDLE_PRINT_MODULE(Kindle_Debug_Resources, "CSS Request: %s\n", url.latin1().data());
	// </lab126>
...
{
	// <lab126>
	KINDLE_PRINT_MODULE(Kindle_Debug_Resources, "User CSS Request: %s\n", url.latin1().data());
	// </lab126>
...
{
	// <lab126>
	KINDLE_PRINT_MODULE(Kindle_Debug_Resources, "Script: %s\n", url.latin1().data());
	// </lab126>
