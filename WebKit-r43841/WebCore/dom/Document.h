...
public:
    ...
    WEBCORE_EXPORT virtual PassRefPtr<Element> createElement(const AtomicString& tagName, ExceptionCode&);
    ...
    void updateLayout();
    WEBCORE_EXPORT void updateLayoutIgnorePendingStylesheets();
    ...
    WEBCORE_EXPORT KURL completeURL(const String&) const;
...
public:
    ...
    */
    ...
    WEBCORE_EXPORT bool setFocusedNode(PassRefPtr<Node>);
    WEBCORE_EXPORT Node* focusedNode() const { return m_focusedNode.get(); }
    ...
    WEBCORE_EXPORT DOMWindow* defaultView() const { return domWindow(); } 
    WEBCORE_EXPORT DOMWindow* domWindow() const;
     ...
     */
    WEBCORE_EXPORT Node* nextFocusableNode(Node* start, KeyboardEvent*);
     ...
     * See http://www.w3.org/TR/html4/interact/forms.html#h-17.11.1
     */
    WEBCORE_EXPORT Node* previousFocusableNode(Node* start, KeyboardEvent*);
    ...
    WEBCORE_EXPORT Element* ownerElement() const;
    ...
    WEBCORE_EXPORT HTMLMapElement* getImageMap(const String& url) const;
...
protected:
    WEBCORE_EXPORT Document(Frame*, bool isXHTML);
