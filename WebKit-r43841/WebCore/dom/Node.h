...
public:
    ...
    WEBCORE_EXPORT virtual bool appendChild(PassRefPtr<Node> newChild, ExceptionCode&, bool shouldLazyAttach = false);
     ...
     */
    WEBCORE_EXPORT Node* traverseNextNode(const Node* stayWithin = 0) const;
    
    // Like traverseNextNode, but skips children and starts with the next sibling.
    WEBCORE_EXPORT Node* traverseNextSibling(const Node* stayWithin = 0) const;
    ...
    WEBCORE_EXPORT RenderBoxModelObject* renderBoxModelObject() const;
    ...
    WEBCORE_EXPORT PassRefPtr<NodeList> getElementsByTagName(const String&);
...
public:
    ...
    WEBCORE_EXPORT bool dispatchMouseEvent(const AtomicString& eventType, int button, int clickCount,
        int pageX, int pageY, int screenX, int screenY,
        bool ctrlKey, bool altKey, bool shiftKey, bool metaKey,
        bool isSimulated = false, Node* relatedTarget = 0, PassRefPtr<Event> underlyingEvent = 0);
    WEBCORE_EXPORT void dispatchSimulatedMouseEvent(const AtomicString& eventType, PassRefPtr<Event> underlyingEvent = 0);
    ...
    WEBCORE_EXPORT const RegisteredEventListenerVector& eventListeners() const;
