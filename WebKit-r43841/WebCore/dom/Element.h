...
public:
    ...
    WEBCORE_EXPORT const AtomicString& getIDAttribute() const;
    bool hasAttribute(const QualifiedName&) const;
    WEBCORE_EXPORT const AtomicString& getAttribute(const QualifiedName&) const;
    WEBCORE_EXPORT void setAttribute(const QualifiedName&, const AtomicString& value, ExceptionCode&);
    void removeAttribute(const QualifiedName&, ExceptionCode&);

    bool hasAttributes() const;

    WEBCORE_EXPORT bool hasAttribute(const String& name) const;
    bool hasAttributeNS(const String& namespaceURI, const String& localName) const;

    WEBCORE_EXPORT const AtomicString& getAttribute(const String& name) const;
    ...
    WEBCORE_EXPORT PassRefPtr<ClientRectList> getClientRects() const;
    WEBCORE_EXPORT PassRefPtr<ClientRect> getBoundingClientRect() const;
    ...
    WEBCORE_EXPORT String innerText() const;
